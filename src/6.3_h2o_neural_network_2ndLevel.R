...
pred_cat_train63d <- as.data.frame(h2o.predict(dl_cat, newdata = train_set.hex))[,3]
pred_cat_test63d <- as.data.frame(h2o.predict(dl_cat, newdata = validation_set.hex))[,3]
...
retrained_dl_all <- do.call(h2o.deeplearning,
                            ## update parameters in place
                            {
                              ...
                              p$validation_frame = test_set.hex  ## no validation frame
                              p
                            })
