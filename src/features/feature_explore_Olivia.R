...
#find2_OI_ = unique_group[grep("2[0-9]OI.", unique_group)]
#[1] 22OI7 20OI0 22OI3 22OI5 21OIE 21OIG 22OIF 22OI8 22OI2 22OIK 21OI0 20OI3 21OI2 20OI2 22OI4 22OIE 22OIO 22OI9 20OI1 20OIF 22OI0 22OI1 21OI3 22OIG 21OI1
#[26] 20OIE

#for(i in 1:26){
#  abcde = table(train_items$group == find2_OI_[i])[2]
#  print(as.character(find2_OI_[i]))
#  print(abcde)
#}
